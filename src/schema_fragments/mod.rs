...
pub const SEARCH_WATCH_INTERVAL_MS_MAX: u64 = 24 * 60 * 60 * 1_000;
pub const SEARCH_WATCH_ITERATIONS_DEFAULT: u32 = 0;
pub const SEARCH_WATCH_ITERATIONS_MAX: u32 = 1_000_000;
...
pub const MCP_SESSION_TURNS_MAX: usize = 1_000;
pub const MCP_SESSION_TURNS_DEFAULT: usize = MCP_SESSION_TURNS_MAX;
pub const MCP_RESOURCES_LIST_MAX: usize = 1_000;
