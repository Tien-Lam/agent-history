...
// ──────────────────────────────────────────────────────────────────────
// Cross-session change tracker (`aghist track <topic>`)
//
// Given a free-text topic, surfaces what *changed* about that topic across
// sessions (e.g. "yesterday I decided X about auth, today I changed it to Y").
// Input: topic string + per-session excerpts of turns that mention the topic.
// Output: a chronological timeline of change events.
// ──────────────────────────────────────────────────────────────────────
