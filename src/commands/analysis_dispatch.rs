    ...
    match command {
        AnalysisCommand::Track(args) => track_command(
            ...
            TrackCommandRequest {
                ...
                topic: &args.topic,
                limit: args.limit,
                force_json: ctx.json_only_output(args.json, "track")?,
        ...
        AnalysisCommand::Decisions(args) => decisions_command(
            ...
            DecisionsCommandRequest {
                ...
                limit: args.limit,
                force_json: ctx.json_only_output(args.json, "decisions")?,
                filters,
                metadata_keys: metadata_keys.as_ref(),
                use_llm: args.llm,
                llm_model: args.llm_model.as_deref(),
        ...
        AnalysisCommand::Todos(args) => todos_command(
            ...
            TodosCommandRequest {
                ...
                kinds: &args.kind,
                limit: args.limit,
                force_json: ctx.json_only_output(args.json, "todos")?,
                use_llm: args.llm,
                llm_model: args.llm_model.as_deref(),
            },
        ),
        AnalysisCommand::Threads(args) => threads_command(
            ...
            ThreadsCommandRequest {
                ...
                limit: args.limit,
                force_json: ctx.json_only_output(args.json, "threads")?,
                use_llm: args.llm,
                llm_model: args.llm_model.as_deref(),
