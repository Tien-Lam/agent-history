...
pub(crate) fn dispatch_report_command(
    ...
    match command {
        Command::Usage(args) => usage_command(providers, filters, args.by, args.limit, args.json),
        Command::Project(args) => {
            ...
            project_command(providers, filters, &args.name, limits, args.json)
        }
        Command::Report(args) => {
            ...
            report_command(providers, filters, window_days, limits, args.json)
        }
