...
**YOU ARE IN: `aghist/polecats/cheedo/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/aghist/` (rig root) or other directories
...
**Your mail address:** `aghist/polecats/cheedo`
**Your rig:** aghist
**Your Witness:** `aghist/witness`
...
| Ask Witness for help | `gt mail send aghist/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`aghist/witness`) when:
...
```bash
gt mail send aghist/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
